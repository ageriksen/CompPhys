...
Further on, we can model a 2-particle system, much like a quantum gate %% cite!!
...
found in the project text %%\cite{}
...
This means that the eigenvalues will change, though one can find them analytically as 3, 5, 11, 15, .. %%\cite{}
